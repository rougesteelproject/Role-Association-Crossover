...
class DatabaseController():
    def __init__(self):
        ...
        self.__user = constants.neo_user
        self.__pass = constants.neo_pass
        self.connection = None

    def create_connection(self):
        self.connection = self._neo4j_create_driver()

    def _neo4j_close_driver(self):
        if self.connection is not None:
            self.connection.close()

    def _neo4j_create_driver(self):
        try:
    ...
    def _neo4j_execute(self, query, parameters=None):
        ...
        try:
            ...
            traceback.print_exc()
            print(f"Query failed: query \'{query}\', parameters:")
            print(parameters)
        finally:
