...
class DatabaseController():
    ...
    def create_db_if_not_exists(self):
        ...
        self.cursor.execute('''CREATE TABLE IF NOT EXISTS actors_history(id INT NOT NULL, timestamp TEXT DEFAULT CURRENT_TIMESTAMP, name TEXT NOT NULL, bio TEXT, death_date DATE)''') #TODO does the history need human-changable death dates? Can I have IMDB update it?
        #TODO history tables for abilities?
